...
//#region
// product.sort((a, b) => (a.id > b.id ? -1 : a.id < b.id ? 1 : 0));
// console.log(product);
...
//#region
// let word = prompt("enter your choice");
// const found = product.find((elem) => {
//   if (elem.name.toUpperCase().trim().includes(word.toUpperCase().trim())) {
//     return elem;
//   }
// });
// console.log(found);
...
//#region
// let result = product.filter((elem) => elem.discontinued == true);
// console.log(result);
//#endregion
...
//#region
// const result = product.filter((elem) => elem.unitPrice > 20);
// console.log(result);
//#endregion
